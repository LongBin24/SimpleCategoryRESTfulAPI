...
public class ProductRepositoryOld {
    ...
    public ProductRepositoryOld() {
        productList.add(new Product(1001, "Cocacola", "Nice when cool", 1.20f, 101,null));
        productList.add(new Product(1002, "Sting", "Unlimited Sweetness", 1.5f, 102,null));
        productList.add(new Product(1003, "Fanta", "So cool and fresh!", 2.00f, 103,null));
    }
